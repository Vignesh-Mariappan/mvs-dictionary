    ...
    <div className='header'>
      ...
      <div className='inputs'>
        <ThemeProvider theme={darkTheme}>
          <TextField className='search' label='Search a word' variant='standard' value={word} onChange={(event) => setWord(event.target.value)} />
          <TextField className='select' select label='Select' helperText='Please select your language' value={category} onChange={(event) => handleSelectChange(event.target.value)}>
